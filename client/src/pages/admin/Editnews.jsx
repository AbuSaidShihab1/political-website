    ...
    const updatenews=(e)=>{
       ...
       if(title=="" || description==""){
           ...
           const formdata=new FormData();
                ...
                console.log(file)
                axios.post(`https://politics-backend.phpshottershondhane.com/update-news/${id}`,formdata)
                .then((res)=>{
                    if(res.data.success){
  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%] lg:w-[60%] m-auto py-[20px] xl:py-[40px] px-[30px]'>
                <section>
                    <h1 className='text-[20px] lg:text-[30px] font-[600] mb-[30px]'>Update News</h1>
                    <form action=""className='w-full'onSubmit={updatenews}>
                        ...
                        <textarea name="" id=""placeholder='Description'onChange={(e)=>{setdescription(e.target.value)}} value={description} className='w-full h-[200px] lg:h-[250px] lg:text-[17px] text-[14px] mt-[20px] border-[1px] border-[#eee] p-[20px] outline-[#00C07C] rounded-[5px]'></textarea><br />
