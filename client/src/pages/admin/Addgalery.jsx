    ...
    const handleform=(e)=>{
       ...
       if(title==""){
               ...
               const formdata=new FormData();
                ...
                console.log(file)
                axios.post(`https://politics-backend.phpshottershondhane.com/add-gallery`,formdata)
                .then((res)=>{
                    if(res.data.success){
  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%] lg:w-[60%] m-auto py-[20px] xl:py-[40px] px-[30px]'>
                <section>
                    <h1 className='text-[20px] lg:text-[30px] font-[600] mb-[30px]'>Add Photo</h1>
                    <form action=""className='w-full'onSubmit={handleform}>
                        <input type="text"onChange={(e)=>{settitle(e.target.value)}} placeholder='Enter Title'className='w-full h-[55px] border-[1px] border-[#eee] p-[20px] outline-[#00C07C] rounded-[5px]' /> <br />
