        ...
        console.log(title)
          ...
          seterrortext("")
           const formdata=new FormData();
                ...
                axios.post(`https://politics-backend.phpshottershondhane.com/add-campaign`,formdata)
                .then((res)=>{
                    if(res){
  ...
  return (
    <section className='w-full h-[100vh] flex font-poppins'>
       ...
       <section className='w-[100%] lg:w-[60%] m-auto py-[20px] xl:py-[40px] px-[30px]'>
                <section>
                    <h1 className='text-[18px] lg:text-[30px] font-[600] mb-[30px]'>Add Campaign</h1>
                    <form action=""className='w-full'onSubmit={handleform}>
                        ...
                        <textarea name=""onChange={(e)=>{setdescription(e.target.value)}}value={description} id=""placeholder='Description' className='w-full h-[250px] mt-[20px] border-[1px] border-[#eee] p-[20px] outline-[#00C07C] rounded-[5px]'></textarea><br />
                        ...
                        <input onChange={(e)=>{setfile(e.target.files[0])}} className="block w-full p-[20px] mt-[10px] text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" />
